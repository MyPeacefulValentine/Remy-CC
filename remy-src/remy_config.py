...
_FIELDS = (
    ...
    _field("REMY_PERMISSION_GATE", None, "bool", "true", "system", "Auto-approve Edit/Write/Read permission prompts for project .claude/ system artifacts", "自动放行项目级.claude/系统工件的Edit/Write/Read权限弹窗", label_en="Permission Gate", label_zh="权限闸门", restart_scope="immediate", advanced=False),
