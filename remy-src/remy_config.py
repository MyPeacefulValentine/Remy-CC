...
_FIELDS = (
    ...
    _field("REMY_LLM_MAX_WORKERS", "OPENAI_MAX_WORKERS", "int", "5", "llm_api", "Concurrent LLM request workers", "LLM并发请求线程数", minimum=1, maximum=10),
    _field("REMY_LLM_RETRY_LIMIT", "OPENAI_RETRY_LIMIT", "int", "3", "llm_api", "LLM request retry limit", "LLM请求重试次数", minimum=0, maximum=10),
    _field("REMY_LLM_TIMEOUT", "OPENAI_TIMEOUT", "int", "300", "llm_api", "LLM request timeout in seconds", "LLM请求超时秒数", minimum=30, maximum=600),
    _field("REMY_LLM_MAX_TOKENS", "OPENAI_MAX_TOKENS", "int", "32768", "llm_api", "Maximum tokens in an LLM response", "LLM响应最大Token数", minimum=1024, maximum=32768),
