...
```
/security-audit [low|medium|high] [diff_range]
```

### Examples

```bash
/security-audit                    # medium effort, origin/HEAD...HEAD
/security-audit high               # high effort, origin/HEAD...HEAD
/security-audit medium HEAD~5...HEAD  # medium effort, last 5 commits
```
